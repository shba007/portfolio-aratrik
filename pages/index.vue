...
/* const imagesArray = [
	['Wedding-001-002', 'Wedding-001-007', 'Portrait-010-001', 'Group-006-002', 'Group-001-003', 'Group-006-001', 'Ceremony-006-002', 'Wedding-001-010', 'Ceremony-006-001', 'Group-005-001', 'Portrait-014-001', 'Wedding-001-011', 'Ceremony-006-005', 'Wedding-001-012', 'Ceremony-006-003', 'Group-001-001', 'Ceremony-006-007'],
	['Portrait-016-001', 'Portrait-003-001', 'Portrait-004-001', 'Group-002-001', 'Portrait-001-001', 'Portrait-008-001', 'Portrait-012-001', 'Wedding-001-006', 'Wedding-001-013', 'Portrait-011-001', 'Group-004-001', 'Portrait-002-001', 'Ceremony-006-006', 'Portrait-007-001', 'Portrait-009-001',],
	['Group-003-001', 'Portrait-013-001', 'Portrait-005-001', 'Wedding-001-008', 'Portrait-006-001', 'Wedding-001-009', 'Wedding-001-003', 'Wedding-001-005', 'Group-001-002', 'Wedding-001-004', 'Wedding-001-014', 'Wedding-001-001', 'Ceremony-006-004', 'Portrait-015-001', 'Ceremony-006-008']
] */
const imagesArray = [
	[
	...
	<main class="relative">
		...
		<div class="px-2 md:px-4 w-screen h-screen overflow-hidden">
			<div class="relative flex gap-2 md:gap-4 h-fit transition-transform ease-linear duration-100"
				...
				<ImageColum v-for="images, index in imagesArray" :images="images"
