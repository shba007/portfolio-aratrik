...
<template>
	<section id="hero" @click="toggleDark()"
		...
		<div class="relative row-start-2 md:row-start-1 col-start-1 md:col-start-2 col-span-3 md:col-span-2 -z-10">
			<img :src="`/images/background-light.webp`" alt="background"
				class="dark:hidden  relative right-0 bottom-0 -translate-y-[10%] -translate-x-[25%] md:-translate-x-[10%] scale-[165%] md:scale-125" />
			<img :src="`/images/background-dark.webp`" alt="background"
				class="hidden dark:inline relative right-0 bottom-0 -translate-y-[10%] -translate-x-[25%] md:-translate-x-[10%] scale-[165%] md:scale-125" />
		</div>
